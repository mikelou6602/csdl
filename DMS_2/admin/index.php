							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-8">
										...
										?>
										<h5 class="my-1 text-white text-center"style="font-size: 30px;"><?php echo $num2 ?></h5>
										<h5 class="text-white">Total</h5>
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-8">
										...
										?>
										<h5 class="my-1 text-white text-center"style="font-size: 30px;"><?php echo $pp; ?></h5>					
										<h5 class="text-white">Total</h5>
							...
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-8">
										...
										?>			
										<h5 class="my-1 text-white text-center"style="font-size: 30px;"><?php echo $rep; ?></h5>
										<h5 class="text-white">Total</h5>
						...
						<div class="col-md-3 bg-success mx-3 my-4" style="height: 130px;">
							<div class="col-md-12">
								<div class="row">
									<div class="col-md-8">
										<?php
											$income = mysqli_query($connect,"SELECT * FROM sum(amount_paid) as profit FROM income");
											$row = mysqli_fetch_array($income);
											$inc = $row['profit'];
										?>
										<h5 class="my-1 text-white text-center"style="font-size: 30px;"><?php echo "$$inc" ?></h5>
										<h5 class="text-white">Total</h5>
