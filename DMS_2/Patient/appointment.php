                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <?php
                            ...
                            $sel = mysqli_query($connect,"SELECT * FROM patient WHERE username=''");
                            ...
                            if(isset($_POST['book'])){
                                ...
                                if(empty($sym)) {
                                    ...
                                    if($res) {
                                        echo "<srcipt>alert('You have booked an appointment.')</script>";
                                    }     
                                }
                            }    
                        ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form method="post">
                                    ...
                                    <input type="date" name="date" class="from control">
                                    <label> Symptoms </label>
                                    <input type="text" name="sym" class="from control" autocomplete="off" placeholder="Enter Symptoms">
